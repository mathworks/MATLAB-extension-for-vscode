...
class MatlabExtension extends BaseService {
    ...
    private readonly workspaceVariableProvider: WorkspaceVariableProvider
    ...
    constructor (context: vscode.ExtensionContext) {
        ...
        // Initialize Workspace Variable Provider
        this.workspaceVariableProvider = new WorkspaceVariableProvider(this.mvm)
        ...
        this.own(
            ...
            vscode.window.registerWebviewViewProvider(WorkspaceVariableProvider.viewType, this.workspaceVariableProvider),
            vscode.commands.registerCommand('matlab.refreshWorkspaceVariables', async () => await this.workspaceVariableProvider.refresh())
        )
