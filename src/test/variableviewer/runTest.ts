...
// Test runner that bootstraps a jsdom environment for Variable Viewer tests.
...
// requestAnimationFrame / cancelAnimationFrame are not available in Node.js
...
// scrollIntoView is not implemented in jsdom — provide a no-op
